...
//frank modify
#define CONFIG_MXT_PLATFORM_MTK_LEGACY   
#undef CONFIG_MXT_PLATFORM_MTK_LEGACY  

//#define CONFIG_MXT_PLATFORM_QUALCOMM
#if defined(CONFIG_MXT_PLATFORM_MTK_LEGACY)
...
void atmel_power_switch(s32 state)
{
	int ret;
...
#if defined(CONFIG_MXT_PLATFORM_MTK_LEGACY_EXAMPLE_2)
	//.irqflags = IRQF_TRIGGER_FALLING
	//CUST_EINTF_TRIGGER_FALLING
	mt_set_gpio_mode(GPIO_CTP_EINT_PIN, GPIO_CTP_EINT_PIN_M_EINT);
	mt_set_gpio_dir(GPIO_CTP_EINT_PIN, GPIO_DIR_IN);
