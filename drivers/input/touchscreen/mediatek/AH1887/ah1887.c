...
#if 0
//#define CUST_EINT_MHALL_NUM		hall_irq_eint1//CUST_EINT_HALL_1_NUM   
...
#define CUST_EINT_MHALL_1_NUM		2//CUST_EINT_HALL_2_NUM 
...
static const struct file_operations cust_hall_fops = { 
    .read =hall_proc_read,
};
...
///del //#define GPIO_MHALL1_EINT_PIN         (GPIO117 | 0x80000000)
...
//#endif
///del temp/ extern int tpd_enable_high_Sensitivity(int enable);
...
static int ah1887_probe(struct platform_device *pdev)  
{
	...
	mt_eint_unmask(ah1887_gpio_number2);//(CUST_EINT_MHALL_1_NUM);  
