...
static kal_uint32 open(void)
{
	...
	printk("[humingming] befor sensor init\n");
	sensor_init();
...
void S5K5E2YA_MIPI_algorithm_otp_wb1(struct S5K5E2YA_MIPI_otp_struct *otp)
{
	...
	kal_uint32 Golden_RG, Golden_BG, Current_RG, Current_BG, R_ration, B_ration;
	...
	Golden_RG = (R_gold*1000)/G_gold;
	Golden_BG = (B_gold*1000)/G_gold;

	Current_RG = (R_avg*1000)/G_avg;
	Current_BG = (B_avg*1000)/G_avg;
	
	R_ration=(Golden_RG*1000)/Current_RG;
	B_ration=(Golden_BG*1000)/Current_BG;
